...
for sh_name in spendings_drive['compte'].unique():
    try:
        ...
        rows_to_append = gs.get_number_of_rows_to_append(spendings=spendings_drive,
                                                         account_name=sh_name)
        ts_values, values = gs.get_timestamp_and_values(spendings=spendings_drive,
                                                        account_name=sh_name)
        ...
        ew.update_total_formula(ws_name=sh_name, row_to_insert_from=last_row_number)
